...
class Game:
    ...
    def run( self ):
        ...
        step = 0
        def printCabecera():
            cadena = "@RELATION pacman-data-training\n" \
                     "\n"\
                     "\n"\
                     "\n"\
                    "@ATTRIBUTE position-x NUMERIC\n"  \
		    "@ATTRIBUTE position-y NUMERIC\n"  \
		    "@ATTRIBUTE pacman_legal {Action_west, Action_stop, Action_east, Action_north, Action_south}" \
		    ...
		    "@ATTRIBUTE distance3 NUMERIC\n"  \
		    "@ATTRIBUTE distance4 NUMERIC\n"    \
		    "\n" \
		    "       @data\n"
